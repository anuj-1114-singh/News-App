      ...
      <div>
        ...
        <Navbar/>
         ...
         <Routes>
          ...
          <Route exact path="/sports" element={<News key="ports" pageSize={9} country="us" category="sports"/>}/>
          ...
          <Route  path="/" element={<News key="eneral" pageSize={9} country="us" category="general"/>}/>
